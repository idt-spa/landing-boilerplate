...
const heroText = {
  ...
  description: {
    line1: "Bring functionalities of other apps",
    line2: "into your Notion workspaces.",
  },
  buttons: {
...
export default function HeroTypeTwo() {
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
      ...
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative inline-block whitespace-nowrap text-blue-600">
          <UnderlineSVG />
          <span className="relative">{heroText.heading.highlighted}</span>
        </span>{" "}
      ...
      <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
        ...
        >
          <span>{heroText.buttons.firefox}</span>
        </a>
