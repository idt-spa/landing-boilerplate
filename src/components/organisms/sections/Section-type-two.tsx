export default function SectionTypeTwo() {
  return (
    <section className="dark:bg-gray-800 bg-[#F9F9F9]">
      <div className="max-w-[1440px]  mx-auto flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-0 px-8 lg:px-16 py-10">
        ...
        <svg
          ...
          height="395"
          viewBox="0 0 359 395"
          className="w-[200px] h-[200px] lg:w-[360px] lg:h-[400px] order-1 lg:order-2"
          fill="none"
        ...
        >
          ...
          <circle
            ...
            cy="186.5"
            r="62"
            className="dark:fill-white dark:stroke-black fill-black stroke-white"
            fill="black"
            stroke="black"
          ></circle>
          <ellipse
